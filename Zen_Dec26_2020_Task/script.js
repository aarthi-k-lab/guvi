...
function getindexpage(){
    ...
    quiztitle.innerText="Quick Quiz";
...
function getHeaderContent() {
    ...
    progressdiv.append(progressdivtext,br,progreessiveinputrange);
...
option1.setAttribute("class","option1 button container");
...
option2.setAttribute("class","option2 button container");
...
option3.setAttribute("class","option3 button container");
...
option4.setAttribute("class","option4 button container");
...
function getNextButton(){
    ...
    nextButtondiv.setAttribute("class","nextbuttonDiv button container");
